...
class WeatherDetailsPortrait extends StatefulWidget {
  ...
  WeatherDetailsPortrait(this.cityDetails, this.weatherReport);

  @override
  State<WeatherDetailsPortrait> createState() =>
      _WeatherDetailsPortraitPageState();
}

class _WeatherDetailsPortraitPageState extends State<WeatherDetailsPortrait> {
  int clickedIndex;
  @override
          ...
          child: SafeArea(
            child: Column(
              ...
              children: [
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(
                              color: Colors.black, fontSize: SizeConfig.font17),
                        ),
                      ),
                    ),
                    Padding(
                ...
                Padding(
                  padding: EdgeInsetsDirectional.only(
                      top: SizeConfig.padding32, start: SizeConfig.padding16),
                  child: Text(
                    "Next 5 days",
                    style: TextStyle(
                        color: Colors.black,
